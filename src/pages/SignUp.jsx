    ...
    <>
      <div className="flex justify-center relative" >
        <div className="container w-[300px] h-500px bg-slate-600 p-5 rounded-xl my-20">
          <header>
          <h1 className="text-4xl font-bold ml-14 mb-4 text-green-600 ">Register</h1> 
          </header>
          ...
          <input type="text"
            ...
            <div  className="group flex relative">
              ...
              <div className="items-center space-x-16 ">
                <button onClick={()=> navigate('/sign-in')} className="btn btn-md bg-green-500 text-white font-bold ml-3 hover:text-black">
                  Sign In
                </button>
